...
#define BOOT_CPU_XTAL_SPEED_KHZ          (24000) //not used
/** \brief Desired system speed. */
#define BOOT_CPU_SYSTEM_SPEED_KHZ        (528000)//(DEFAULT_SYSTEM_CLOCK/1000)//used by systick timer, changed follow cpu frequency configuration
...
#define BOOT_COM_NET_ENABLE               (1)//dawei
...
#define BOOT_COM_NET_DHCP_ENABLE          0//(1)//dawei
/** \brief Configure the 1st byte of the IP address */
#define BOOT_COM_NET_IPADDR0              (192)//dawei check the test addr
...
#define BOOT_COM_RS232_BAUDRATE          115200 //9600//(115200)
/** \brief Configure number of bytes in the target->host data packet. */
#define BOOT_COM_RS232_TX_MAX_DATA       (64)
/** \brief Configure number of bytes in the host->target data packet. */
#define BOOT_COM_RS232_RX_MAX_DATA       (64)
/** \brief Select the desired UART peripheral as a zero based index. */
#define BOOT_COM_RS232_CHANNEL_INDEX     (2)//use in RT1170 LPUART2, GPIO_DISP_B2_11/GPIO_DISP_B2_10, J9 - p2 & 4
 ...
 */
//#define BOOT_FLASH_VECTOR_TABLE_CS_OFFSET (0x1F8)//checksum offset of application
#define BOOT_FLASH_VECTOR_TABLE_CS_OFFSET (0x1C)//checksum offset of application, put in vectable 0x1c, the checksum is from 0x00 - 0x18
