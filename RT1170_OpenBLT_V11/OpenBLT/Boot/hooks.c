...
blt_bool CpuUserProgramStartHook(void)
{
    ...
    PRINTF("check SW7 on RT1170 EVK\r\n");
    #define EXAMPLE_SW_GPIO         BOARD_USER_BUTTON_GPIO
    #define EXAMPLE_SW_GPIO_PIN     BOARD_USER_BUTTON_GPIO_PIN
    
    IOMUXC_SetPinMux(
      IOMUXC_WAKEUP_DIG_GPIO13_IO00,          /* IOMUXC_WAKEUP_DIG_GPIO13_IO00 */
      1U);
    IOMUXC_SetPinConfig(
      IOMUXC_WAKEUP_DIG_GPIO13_IO00,          /* no pull external, need pull up internally */
      0x0CU);                                 
    ...
    {
           PRINTF("SW7 wakeup is pressed.\r\n");
           return BLT_FALSE;
    }
    
    PRINTF("SW7 wakeup is not pressed.\r\n");
